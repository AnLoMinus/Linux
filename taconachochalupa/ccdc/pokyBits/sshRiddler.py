...
###########################################################################
#+++++++++
# prereqs (tested on ubuntu 18.04)
#+++++++++
# MAKE '#!/usr/bin/env python' THE FIRST LINE IN THE SCRIPT FILE
#	apt install python-pip && pip install paramiko==2.0.8
#
#-------
# usage
#-------
# 	./script.py --userList LIST IP
# Seems to not work on anything around 7.6+
#============================================================================
#!/usr/bin/env python
